...
#define CS_LOW()	CS_ENABLE()	    /* Set CS low */
#define	CS_HIGH()	CS_DISABLE()	/* Set CS high */
#define	IS_CS_LOW	!(PINB & CS)	/* Test if CS is low */

/* Peripheral controls (Platform dependent) */
#define MMC_CD			1            	  /* O modulo não possui leitura de card detected *Test if card detected.   yes:true, no:false, default:true */
#define MMC_WP			0            	  /* o modulo nao possu leitura de read only *Test if write protected. yes:true, no:false, default:false */
